...
#Train model
batch = 32
history = model.fit(x_train,y_train,epochs=200,class_weight=class_weights,batch_size=batch,validation_split=0.15,verbose=1)
...
cm2,preds2 = evaluate_shot(no_act_id,y_pred,y_test.argmax(axis=1),class_vocab,0.7) #evaluate results
...
videos_folder = "videos/" #folder with the raw videos
dst_folder = "test_visualization3/" #folder where videos will be saved
